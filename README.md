...
### Overview
This component implements and evaluates three distinct time series smoothing techniques to further analyze temperature trends across four Indian cities (Mumbai, Delhi, Dehradun, Jodhpur) from <Insert years pls>.
