import numpy as np
import pandas as pd
from raw_data.jodhpur_raw import get_raw_data
...
# known historical events for jodhpur - these should never be removed
KNOWN_EXTREMES = [
    (2019, 6, 'MAX', 'Jodhpur Jun 2019 heatwave - part of wider Rajasthan 47C+ surge'),
]
